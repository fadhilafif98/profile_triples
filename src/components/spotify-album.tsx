...
export default function SpotifyAlbum({ album }: SpotifyAlbumProps) {
  return (
    <div className="bg-gray-800/90 rounded-lg overflow-hidden shadow-xl max-w-4xl mx-auto">
      <div className="p-6 md:p-8">
        <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center md:items-start">
          ...
          <div className="flex-1 text-center md:text-left">
            <div className="inline-block bg-gray-700/50 px-2 py-1 rounded text-xs text-gray-300 mb-2">
              {album.releaseYear}
            </div>
